...
Freelance Dashboard
 ...
 Freelance Dashboard is a modern dashboard application to manage clients, projects, and payments. Built with React, Vite, Tailwind CSS, and TypeScript, it features dark mode and global state management using the Context API.
